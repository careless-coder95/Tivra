...
def get_verify_keyboard():
    """Sirf Verify button — jab tak join nahi kiya."""
...
➻ <b>Bold</b>, <i>italic</i>, <code>code</code> sab kuch chal sakta hai.
...
async def verify_button_handler(client: Client, msg: Message):
    ...
    if joined:
        ...
        await msg.reply_text(
            "❌ <b>Abhi bhi kuch channels join nahi kiye!</b>\n\nNiche diye buttons se join karo phir dobara Verify dabao.",
            parse_mode=enums.ParseMode.HTML,
            reply_markup=get_fsub_inline(missing),
        )


# ✅ VERIFY — Inline callback se (welcome photo ke button se)
...
async def tivra_pay_handler(client: Client, msg: Message):
    ...
    # ──────────────────────────────────────────────
    # ✏️ TIVRA PAY TEXT — Yahan apna text likho
    # ──────────────────────────────────────────────
    text = f"""
<b>💳 TIVRA PAY</b>
━━━━━━━━━━━━━━━━━━━━
...
"""
    ...
    # ✏️ INLINE BUTTONS — Apne buttons yahan set karo
...
async def support_handler(client: Client, msg: Message):
    ...
    # ──────────────────────────────────────────────
    # ✏️ SUPPORT TEXT — Yahan apna text likho
    # ──────────────────────────────────────────────
    text = f"""
<b>📞 SUPPORT</b>
━━━━━━━━━━━━━━━━━━━━
...
async def channel_handler(client: Client, msg: Message):
    ...
    # ──────────────────────────────────────────────
    # ✏️ CHANNEL TEXT — Yahan apna text likho
    # ──────────────────────────────────────────────
    text = f"""
<b>📢 OUR CHANNELS</b>
━━━━━━━━━━━━━━━━━━━━
...
async def contact_us_handler(client: Client, msg: Message):
    ...
    # ──────────────────────────────────────────────
    # ✏️ CONTACT US TEXT — Yahan apna text likho
    # ──────────────────────────────────────────────
    text = f"""
<b>📩 CONTACT US</b>
━━━━━━━━━━━━━━━━━━━━
